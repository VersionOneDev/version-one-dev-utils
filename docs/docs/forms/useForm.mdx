...
| onSanitize              | `function` |                    | A function which sanatizes the value of form fields when they are set and/or updated. The function must be able to accept an individual value or all values in the form. |
