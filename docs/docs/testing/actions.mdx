...
This component recieves a data-testid prop of `addTodoButton`. The components test file mimics a button click with helper function `userEvent` from `@testing-library/react`.
